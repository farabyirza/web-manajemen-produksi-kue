...
<div class="col-md-12">
                  <h2 style="text-align: center; font-family: Blagovest">EDIT PENGAMBILAN</h2>   
                        ...
                        <form method="post" action="config/edit_pengambilan_harian.php">
                        ...
                        <td>  <div class="col-xs-2"><input class="form-control" type="text" name="tgl_ambil_tb" value="<?php echo $data['tgl_ambil_tb']; ?>">
                        </div></td>
                        </tr>
                        <tr>
