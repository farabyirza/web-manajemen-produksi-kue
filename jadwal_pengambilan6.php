<h5 style="text-align: right; font-family: Blackletter"><b><u>3</u></b></h5>
  ...
  <li class="active"><a href="index.php?halaman=jadwal_pengambilan6">Sabtu</a></li>
...
<!--   <li><a href="index.php?halaman=jadwal_pengambilan8">Jumat</a></li> -->
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id,so,tgl_ambil_tb,rata,rata_pb,rata_tc FROM jadwal_pengambilan WHERE tgl_ambil_tb LIKE '%Sabtu%'")or die(mysqli_error($connect));
...
<tr>
  ...
  <li class="page-item active"><a class="page-link" href="index.php?halaman=jadwal_pengambilan6">Jadwal Pengambilan</a></li>
  <li class="page-item"><a class="page-link" href="index.php?halaman=draft6">Draft</a></li>
