...
<div class="col-md-12">
                        ...
                        <form method="post" action="config/edit_input_pengambilan2.php">
                        ...
                        <td>  <div class="col-xs-4"><input class="form-control" type="date" name="tgl_ambil_tb" value="<?php echo $data['tgl_ambil_tb']; ?>">
                        </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <input class="form-control" type="text" name="rata"  id="rata" onfocus="hit3()" onkeyup="hitpb5()" value="<?php echo $data['rata']; ?>">
                            </div>
                            ...
                            <input class="form-control" type="text" name="rata_tc"  id="rata_tc" onfocus="hit4()" value="<?php echo $data['rata_tc']; ?>">
                            </div>
