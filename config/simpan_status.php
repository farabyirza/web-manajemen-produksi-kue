...
$status_ngadon = $_POST['status_ngadon'];
// Ambil data nama dan masukkan ke variabel nama
...
$query = "UPDATE jadwal_produksi SET status_ngadon='$status_ngadon' WHERE id='$id'";
