...
$edit = mysqli_query($connect,"UPDATE tbl_daily SET id='$id', tgl='$tgl', so='$so', pst_tgl='$pst_tgl', pst_tb='$pst_tb', pst_pb='$pst_pb', pst_tc='$pst_tc' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_daily3">';			
