...
$so = $_POST['so'];
$tgl_ambil_tc = $_POST['tgl_ambil_tc']; // Ambil data telp dan masukkan ke variabel telp
...
$edit = mysqli_query($connect,"UPDATE pesanan_mingguan_cream SET id='$id', so='$so', tgl_ambil_tc='$tgl_ambil_tc', ambil_vanila='$ambil_vanila', ambil_kopi='$ambil_kopi', ambil_tc='$ambil_tc' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=jadwal_pesanan_mingguan_cream2">';			
