...
$edit = mysqli_query($connect,"UPDATE jadwal_pengambilan SET id='$id', so='$so', pst_tgl='$pst_tgl', tgl_ambil_tb='$tgl_ambil_tb', tgl_produksi='$tgl_produksi', rata_ori='$rata_ori', rata_cho='$rata_cho', rata_che='$rata_che', rata='$rata', rata_kk='$rata_kk', rata_kv='$rata_kv', rata_tc='$rata_tc', rata_pb='$rata_pb', pengambilan='$pengambilan' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=jadwal_terinput">';			
