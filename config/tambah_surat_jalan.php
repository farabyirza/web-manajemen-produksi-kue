...
// Buat sebuah alert sukses, dan redirect ke halaman awal (index.php)
 $querydaily		= "INSERT INTO surat_jalan_bun VALUES ('id','$so','$tgl_ambil_tb','$tgl_surat','$lokasi','$ambil_ori','$ambil_cho','$ambil_che','$ambil_tb')";
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_surat_jalan">';
