...
$edit = mysqli_query($connect,"UPDATE surat_jalan SET id='$id', so='$so', tgl_ambil_tb='$tgl_ambil_tb', tgl_surat='$tgl_surat', lokasi='$lokasi', pic='$pic', rata_ori='$rata_ori', rata_cho='$rata_cho', rata_che='$rata_che', rata='$rata', rata_kk='$rata_kk', rata_kv='$rata_kv', rata_tc='$rata_tc', rata_pb='$rata_pb' WHERE id='$id'");
