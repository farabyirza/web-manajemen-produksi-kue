...
// Buat sebuah alert sukses, dan redirect ke halaman awal (index.php)
 $querydaily		= "INSERT INTO surat_jalan_cream VALUES ('id','$so','$tgl_surat','$lokasi','$ambil_kopi','$ambil_vanila','$ambil_tc')";
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=surat_jalan_cream">';
