...
// Buat sebuah alert sukses, dan redirect ke halaman awal (index.php)
 $querydaily		= "INSERT INTO surat_jalan_paperbag VALUES ('id','$so','$tgl_surat','$lokasi','$ambil_pb')";
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=surat_jalan_pb">';
