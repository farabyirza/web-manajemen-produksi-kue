...
// Buat sebuah alert sukses, dan redirect ke halaman awal (index.php)
 $querydaily		= "INSERT INTO pesanan_mingguan_cream VALUES ('id','$so','$tgl_ambil_tc','$ambil_vanila','$ambil_keju','$ambil_tc')";
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=pesanan_mingguan_cream">';
