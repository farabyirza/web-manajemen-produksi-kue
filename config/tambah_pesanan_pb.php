...
// Buat sebuah alert sukses, dan redirect ke halaman awal (index.php)
 $querydaily		= "INSERT INTO pesanan_mingguan_paperbag VALUES ('id','$so','$tgl_ambil_pb','$ambil_pb')";
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=pesanan_mingguan_pb">';
