...
// $querydaily		= mysqli_query($connect,"INSERT INTO jadwal_produksi VALUES '$id','$tgl','$so','$sisa_ori','$sisa_cho','$sisa_che','$sisa_tb','$sisa_pb','$sisa_kk','$sisa_kv','$sisa_tc','$pesan_ori','$pesan_cho','$pesan_che','$pesan_tb','$pesan_pb','$pesan_kk','$pesan_kv','$pesan_tc','$ngadon_ori','$ngadon_cho','$ngadon_che','$ngadon_tb','$ngadon_pb','$ngadon_kk','$ngadon_kv','$ngadon_tc' WHERE id='$id'");
...
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=jadwal_ngadon">';
