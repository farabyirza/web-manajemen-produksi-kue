...
$so = $_POST['so'];
$tgl_ambil_pb = $_POST['tgl_ambil_pb']; // Ambil data telp dan masukkan ke variabel telp
...
$edit = mysqli_query($connect,"UPDATE pesanan_mingguan_paperbag SET id='$id', so='$so', tgl_ambil_pb='$tgl_ambil_pb', ambil_pb='$ambil_pb' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=jadwal_pesanan_mingguan_pb4">';			
