  ...
  <li class="active"><a href="index.php?halaman=surat_jalan4">Kamis</a></li>
  ...
  <li><a href="index.php?halaman=surat_jalan7">Minggu</a></li>
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id,so,ambil_ori,ambil_cho,ambil_che,ambil_tb FROM pesanan_mingguan_bun WHERE tgl_ambil_tb LIKE '%Kamis%'")or die(mysqli_error($connect));
