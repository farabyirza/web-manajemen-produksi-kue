<h5 style="text-align: right; font-family: Blackletter"><b><u>3</u></b></h5>
                     <h2 style="text-align: center; font-family: Blagovest">JADWAL PENGAMBILAN PESANAN</h2>   
                        ...
                        <form action="index.php?halaman=pengambilan_filter" method="POST">
<!--                                             <tr>
<td>Tanggal Awal</td>
<td><input type="date" name="tgl_awal"/></td>
...
<!--   <li><a href="index.php?halaman=jadwal_pengambilan7">Minggu</a></li> -->
  <li class="active"><a href="index.php?halaman=jadwal_pengambilan">Senin</a></li>
  <li><a href="index.php?halaman=jadwal_pengambilan2">Selasa</a></li>
  <li><a href="index.php?halaman=jadwal_pengambilan3">Rabu</a></li>
  <li><a href="index.php?halaman=jadwal_pengambilan4">Kamis</a></li>
<!--   <li><a href="index.php?halaman=jadwal_pengambilan8">Jumat</a></li> -->
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id,so,tgl_ambil_tb,rata,rata_pb,rata_tc FROM jadwal_pengambilan WHERE tgl_ambil_tb LIKE '%Senin%' ORDER BY so ASC")or die(mysqli_error($connect));
...
<tr>
  ...
  <li class="page-item active"><a class="page-link" href="index.php?halaman=jadwal_pengambilan">Jadwal Pengambilan</a></li>
  <li class="page-item"><a class="page-link" href="index.php?halaman=draft">Draft</a></li>
                        ...
                        <!-- <ul class="pagination">
 						<li class="active"><a href="index.php?halaman=jadwal_pesanan_mingguan">Kue</a></li>
