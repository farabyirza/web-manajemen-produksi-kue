...
$edit    = "SELECT tgl_ambil_tb, sum(rata_ori), sum(rata_cho), sum(rata_che), sum(rata), sum(rata_kk), sum(rata_kv), sum(rata_tc), sum(rata_pb) FROM jadwal_pengambilan WHERE tgl_ambil_tb LIKE '%(Jumat2)%'";
...
<div class="col-md-12">
                     <h2 style="text-align: center; font-family: Blagovest">INPUT PRODUKSI</h2>   
                        ...
                        <td> <div class="col-xs-2"> <input class="form-control" type="text" name="tgl" value="<?php echo $data['tgl_ambil_tb']; ?>">
                        </td></div>
                        </tr>
                        <tr>
                            ...
                            <input class="form-control" type="text" name="sisa_ori" id="sisa_ori" onkeyup="htg1()" onkeyup="hit8()">
                            </div>
                            <div class="col-xs-2">
                            <label >Chocolate</label>
                            <input class="form-control" type="text" name="sisa_cho" id="sisa_cho" onkeyup="htg2()" onkeyup="hit8()">
                            </div>
                            <div class="col-xs-2">
                            <label >Cheese</label>
                            <input class="form-control" type="text" name="sisa_che" id="sisa_che" onkeyup="htg3()" onkeydown="hit8()">
                            </div>
                            <div class="col-xs-2">
                            <label >Total Bun</label>
                            <input class="form-control" type="text" name="sisa_tb" id="sisa_tb" onkeyup="htg4()" onkeydown="hitpb1()">
                            </div>
                            ...
                            <div class="col-xs-2">
                            <label >Krim Keju</label>
                            <input class="form-control" type="text" name="sisa_kk"  id="sisa_kk" onkeyup="htg5()" onkeyup="hit9()">
                            </div>
                            <div class="col-xs-2">
                            <label >Krim Vanila</label>
                            <input class="form-control" type="text" name="sisa_kv"  id="sisa_kv" onkeyup="htg6()" onkeydown="hit9()">
                            </div> 
                            <div class="col-xs-2">
                            <label >Total Cream</label>
                            <input class="form-control" type="text" name="sisa_tc"  id="sisa_tc" onkeyup="htg7()">
                            </div>
                            ...
                            <div class="col-xs-2">
                            <label> Original </label>
                            <input class="form-control" type="text" name="produksi_ori"  id="produksi_ori" onkeyup="htg1()" onkeyup="hit11()">
                            </div>
                            <div class="col-xs-2">
                            <label >Chocolate</label>
                            <input class="form-control" type="text" name="produksi_cho"  id="produksi_cho" onkeyup="htg2()" onkeyup="hit11()">
                            </div>
                            <div class="col-xs-2">
                            <label >Cheese</label>
                            <input class="form-control" type="text" name="produksi_che"  id="produksi_che" onkeyup="htg3()" onkeydown="hit11()">
                            </div>
                            <div class="col-xs-2">
                            <label >Total Bun</label>
                            <input class="form-control" type="text" name="produksi_tb"  id="produksi_tb" onkeyup="htg4()" onkeyup="hitpb2()">
                            </div>
                            <tr>
                            <td style = "font-size: 20px; font-family: Courier, sans-serif; text-align: center"></td>
                            <td> 
                            <div class="col-xs-2">
                            <label >Krim Keju</label>
                            <input class="form-control" type="text" name="produksi_kk"  id="produksi_kk" onkeyup="htg5()" onkeyup="hit12()">
                            </div>
                            <div class="col-xs-2">
                            <label >Krim Vanila</label>
                            <input class="form-control" type="text" name="produksi_kv"  id="produksi_kv" onkeyup="htg6()" onkeydown="hit12()">
                            </div> 
                            <div class="col-xs-2">
                            <label >Total Cream</label>
                            <input class="form-control" type="text" name="produksi_tc"  id="produksi_tc" onkeyup="htg7()">
                            </div>
                            <tr>
                            <td style = "font-size: 20px; font-family: Courier, sans-serif; text-align: center"></td>
                            <td> 
                            <div class="col-xs-2">
                            <label >Paper Bag</label>
                            <input class="form-control" type="text" name="produksi_pb"  id="produksi_pb">
                            </div>
                            </td>
                            </tr>
