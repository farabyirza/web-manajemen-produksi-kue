...
<div class="col-md-12"> 
                        ...
                        <form method="post" action="config/input_surat_jalan.php">
                        ...
                        <td>  <div class="col-xs-4"><input class="form-control" type="date" name="tgl_surat">
                        </div></td>
                        </tr>
                        <tr>
                        ...
                        <td>  <div class="col-xs-4"><input class="form-control" type="text" name="lokasi">
                        </div></td>
                        </tr>
                        <tr>
                        <tr>
                        <td style = "font-size: 20px; font-family: Courier, sans-serif; text-align: center"> PIC </td>
                        <td>  <div class="col-xs-4"><input class="form-control" type="text" name="pic">
                        </div></td>
                        </tr>
                        <tr>
