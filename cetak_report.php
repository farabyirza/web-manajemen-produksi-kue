...
<body>
                ...
                <h2 style="text-align: center; font-family: Blagovest">DATA DAILY REPORT</h2>   
                       <h4 style="text-align: center; font-family: Blackletter">Halaman ini adalah halaman untuk menampilkan data <b>STOCK OPNAME AWAL</b> pada <b><i>Daily Report</i></b> yang telah di-<i>input</i></h4> 
    ...
    <?php
                       ...
                       $query = mysqli_query($connect, "SELECT id,so,tgl,soa_ori,soa_cho,soa_che,soa_tb,soa_pb,soa_kk,soa_kv,soa_tc,tgl_ambil_tb FROM tbl_daily")or die(mysqli_error($connect));
