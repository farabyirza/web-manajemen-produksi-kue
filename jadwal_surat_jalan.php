  ...
  <li class="active"><a href="index.php?halaman=surat_jalan">Senin</a></li>
  <li><a href="index.php?halaman=surat_jalan2">Selasa</a></li>
  <li><a href="index.php?halaman=surat_jalan3">Rabu</a></li>
  ...
  <li><a href="index.php?halaman=surat_jalan7">Minggu</a></li>
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id,so,tgl_surat, lokasi, ambil_ori,ambil_cho,ambil_che,ambil_tb FROM surat_jalan_bun WHERE tgl_surat LIKE '%Senin%'")or die(mysqli_error($connect));
...
<!--                 <ul class="pagination" style="align-items: center">
 ...
 -->
                        ...
                        <ul class="pagination">
 						<li class="active"><a href="index.php?halaman=jadwal_surat_jalan">Bun</a></li>
              <li><a href="index.php?halaman=jadwal_surat_jalan_cream">Cream</a></li>
              <li><a href="index.php?halaman=jadwal_surat_jalan_pb">Paperbag</a></li>
						</ul>
                        </table>
                    </div>
