...
<!--   <li class="active"><a href="index.php?halaman=jadwal_pengambilan8">Jumat</a></li> -->
</ul> 
      <tr>
        <th>No</th>
        <th>Sales Outlet</th>
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id,so,tgl_ambil_tb,rata,rata_pb,rata_tc FROM jadwal_pengambilan WHERE tgl_ambil_tb LIKE '%(Jumat2)%'")or die(mysqli_error($connect));
...
<tr>
  ...
  <li class="page-item"><a class="page-link" href="index.php?halaman=draft7">Draft</a></li>
              ...
              <li><a href="index.php?halaman=jadwal_pesanan_mingguan_pb">Paperbag</a></li>
						</ul> -->
                        </table>
                    </div>
